...
namespace Unity.ConstraintSamples.Scripts {
    public class mParent : MonoBehaviour
    {
        ...
        public void Update()
        {
            if (this.m_Mode != Mode.Idle)
            {
                ...
                sourceObjects.SetWeight(0, this.m_Mode == Mode.Ground ? 1f : 0f);
                sourceObjects.SetWeight(1, this.m_Mode == Mode.Hand ? 1f : 0f);
                sourceObjects.SetWeight(2, this.m_Mode == Mode.Back ? 1f : 0f);
